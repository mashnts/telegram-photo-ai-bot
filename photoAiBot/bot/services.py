...
async def start_chatting(user_text: str) -> str:
    try:
            ...
            async with session.post(
                ...
                json={
                    ...
                    "messages": [
                        {
                            "role": "system",
                            "content": "You are an assistant in a Telegram bot. Always reply in English using plain text only, without Markdown formatting (do not use **, __, `, [], or () for links). You may use emojis."
                        },
        ...
        return f"Error while contacting the AI: {str(e)}"
...
async def analyze_photo(photo_bytes: bytes) -> str:
    try:
                    ...
                    "messages": [
                        {
                            ...
                            "content": [
                                ...
                                {
                                    "type": "text",
                                    "text": "Analyze this image. Reply in English."
                                }
                            ]
                        }
                    ],
        ...
        return f"Error while analyzing the image: {str(e)}"
...
async def recognize_text_ocr(photo_bytes: bytes) -> str:
    try:
                ...
                json={
                    ...
                    "messages": [{
                        ...
                        "content": [
                            ...
                            {"type": "text", "text": "Recognize and output all text in this image. Output only the recognized text, with no additional comments."}
                        ]
                    }],
                    "max_tokens": 1000
                }
        ...
        return f"Error while recognizing text: {str(e)}"
...
async def detect_faces(photo_bytes: bytes) -> str:
    try:
            ...
            async with session.post(
                ...
                json={
                    ...
                    "messages": [{
                        ...
                        "content": [
                            {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{base64_image}"}},
                            {"type": "text", "text": "Find and describe all people in this image: how many people there are, their approximate age, gender, emotions, and what they are doing. If there are no people, say so. Reply in English."}
                        ]
                    }],
                    "max_tokens": 500
                }
        ...
        return f"Error while recognizing faces: {str(e)}"
